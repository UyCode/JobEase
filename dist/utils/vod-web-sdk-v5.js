...
! function(e, t) {
    "object" == ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) ? module.exports = t(): "function" == typeof define && define.amd ? define([], t) : "object" == ("undefined" == typeof exports ? "undefined" : _typeof(exports)) ? exports.VOD = t() : e.VOD = t()
}(window, function() {
    return function(e) {
        function t(r) {
        ...
        e.exports = function(e) {
            ...
            (function(t) {
                ...
                function o(e) {
                    return c(e, function(e) {
                        return "object" == (void 0 === e ? "undefined" : _typeof(e)) ? o(e) : e
                    })
                }
                    ...
                    m = {
                        apiWrapper: function(e, t) {
                            return function(n, r) {
                                ...
                                var o = (n = i({}, n)).Headers || {};
                                n && "object" == (void 0 === n ? "undefined" : _typeof(n)) && (function() {
            ...
            function P(e, t, n, r, o) {
                ...
                switch (e.nodeType) {
                    case U:
                        ...
                        for (var u = 0; u < a; u++) "xmlns" == (l = i.item(u)).prefix ? o.push({
                            prefix: l.localName,
                            namespace: l.value
                        ...
                        if (M(e, 0, o) && (d = e.prefix || "", f = e.namespaceURI, h = d ? " xmlns:" + d : " xmlns", t.push(h, '="', f, '"'), o.push({
                                prefix: d,
                                namespace: f
            ...
            Y.INVALID_STATE_ERR = (J[11] = "Invalid state", 11), Y.SYNTAX_ERR = (J[12] = "Syntax error", 12), Y.INVALID_MODIFICATION_ERR = (J[13] = "Invalid modification", 13), Y.NAMESPACE_ERR = (J[14] = "Invalid namespace", 14), Y.INVALID_ACCESS_ERR = (J[15] = "Invalid access", 15), o.prototype = Error.prototype, n(Y, o), i.prototype = {
                ...
                cloneNode: function(e) {
                    return function e(t, n, r) {
                        ...
                        for (var a in n) {
                            var s = n[a];
                            "object" != (void 0 === s ? "undefined" : _typeof(s)) && s != o[a] && (o[a] = s)
                        }
                ...
                appendChild: function(e) {
                    return e.nodeType === Q ? this.insertBefore(e, null) : function(e, t) {
                        ...
                        return r = e.lastChild, t.parentNode = e, t.previousSibling = r, t.nextSibling = null, r ? r.nextSibling = t : e.firstChild = t, e.lastChild = t, v(e.ownerDocument, e, t), t
                    }(this, e)
                },
                ...
                nodeType: G
            }, r(S, w), _.prototype.nodeType = $, r(_, h), R.prototype.nodeType = Z, r(R, h), E.prototype.nodeType = q, r(E, h), k.prototype.nodeType = V, r(k, h), D.prototype.nodeName = "#document-fragment", D.prototype.nodeType = Q, r(D, h), B.prototype.nodeType = z, r(B, h), O.prototype.serializeToString = function(e, t, n) {
                return I.call(e, t, n)
            ...
            var r = new RegExp("^([^a-zA-Z_À-ÖØ-öø-ÿͰ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿿、-퟿豈-﷏ﷰ-�])|^((x|X)(m|M)(l|L))|([^a-zA-Z_À-ÖØ-öø-ÿͰ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿿、-퟿豈-﷏ﷰ-�-.0-9·̀-ͯ‿⁀])", "g"),
                ...
                a = function(e, t) {
                    ...
                    return function e(r, a, s) {
                        var c = void 0 === r ? "undefined" : _typeof(r);
            ...
            e.exports = function(e, t) {
                ...
                var n = "",
                    r = "";
                return t && ("object" == (void 0 === t ? "undefined" : _typeof(t)) ? (t.xmlHeader && (n = s(!!t.xmlHeader.standalone)), void 0 !== t.docType && (r = "<!DOCTYPE " + t.docType + ">")) : n = s()), [n, (t = t || {}).prettyPrint && r ? "\n" : "", r, a(e, t)].join("").replace(/\n{2,}/g, "\n").replace(/\s+$/g, "")
            }
        }, function(e, t) {
            e.exports = function(e) {
                function t(e, t) {
                        ...
                        switch (w > b && p(w), e.charAt(w + 1)) {
                            case "/":
                                var S = e.indexOf(">", w + 3),
                                    _ = e.substring(w + 2, S),
                                    R = x.pop();
                                S < 0 ? (_ = e.substring(w + 2).replace(/[\s<].*/, ""), u.error("end tag name: " + _ + " is not complete:" + R.tagName), S = w + 1 + _.length) : _.match(/\s</) && (_ = _.replace(/[\s<].*/, ""), u.error("end tag name: " + _ + " maybe not complete"), S = w + 1 + _.length);
                                var E = R.localNSMap,
                                    k = R.tagName == _;
                                if (k || R.tagName && R.tagName.toLowerCase() == _.toLowerCase()) {
                                    if (r.endElement(R.uri, R.localName, _), E)
                                        for (var D in E) r.endPrefixMapping(D);
                                    k || u.fatalError("end tag name: " + _ + " is not match the current start tagName:" + R.tagName)
                                } else x.push(R);
                                S++;
                                break;
                            case "?":
            ...
            function a(e, t, n) {
                ...
                for (i = e.length; i--;)(l = (a = e[i]).prefix) && ("xml" === l && (a.uri = "http://www.w3.org/XML/1998/namespace"), "xmlns" !== l && (a.uri = n[l || ""]));
                var h;
            ...
            e.exports.init = function(e) {
                ...
                var s = function(e) {
                    ...
                    u = function n() {
                        if (i < t.length && o < e.options.FileParallelLimit) {
                            var r = t[i];
                            "waiting" === r.state && (o++, r.state = "checking", !r.params.UploadData && (r.params.UploadData = {}), a[r.api].call(e, r.params, function(t, i) {
                                "checking" !== r.state && "uploading" !== r.state || (r.state = t ? "error" : "success", o--, n(e), r.callback && r.callback(t, i), "success" === r.state && (delete r.params, delete r.callback))
                            }), c()), i++, n(e)
                        }
                    },
                    l = function(t, r) {
                        ...
                        if (i) {
                            ...
                            if (a || s || "canceled" === r && "paused" === i.state) {
                                ...
                                i.state = r, e.emit("inner-kill-task", {
                                    TaskId: t
                                }), c(), s && (o--, u()), "canceled" === r && (delete i.params, delete i.callback)
                            }
                        }
                    };
                e._addTasks = function(t) {
                    ...
                    }, t.push(d), n[l] = d, !i.IgnoreAddEvent && c(), u(), l
